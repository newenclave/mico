...
namespace mico {
    ...
    public:
        ...
        using token_list  = std::deque<token_info>;
        ...
        const tokens::info &current( ) const
        {
            return current_;
        }

        const tokens::info &peek( ) const
        {
            return peek_;
        }
        ...
        static ItrT skip_whitespaces( ItrT b, EItrT end,
        ...
        static ItrT skip_comment( ItrT b, ItrT end, position_state */*ls*/  )
        {
        ...
        tokens::info next( )
        {
            slice::iterator b = skip_whitespaces( iter_, input_.end( ),
                                                  &lstate_);
